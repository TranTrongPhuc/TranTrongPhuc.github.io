$(document).ready(function () {
	var urlSJChat ="https://c5005ae7dcd1.ngrok.io";
    //web chat
    ...
    //viber chat messnger
    $("body").append("<div id='ViberChatBox' style='position:fixed; right:8.5rem; bottom:1rem; z-index:2147483600;height:50px;width:50px'><iframe src='+"urlSJChat"+/ViberChat/Index?url=" + currentLocation + "' style='width:100%;height:100%;border:0 !important;'></iframe></div>");
